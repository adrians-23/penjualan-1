                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-4 mb-4">
                            ...
                            <textarea class="form-control @error('alamat') is-invalid @enderror"  id="floatingTextarea" name="alamat" placeholder="Alamat">{{$guru->alamat}}</textarea>
                            @error('alamat')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mt-4 mb-4">
                            ...
                            <div class="form-check form-check-inline">
                                <label for="jenis_kelamin">
                                    ...
                                    <input type="radio" name="jenis_kelamin" value="Laki-laki" id="jenis_kelamin"  {{$guru->jenis_kelamin == 'Laki-laki'? 'checked' : ''}}>Laki-Laki
                                    <input type="radio" name="jenis_kelamin" value="Perempuan" id="jenis_kelamin"  {{$guru->jenis_kelamin == 'Perempuan'? 'checked' : ''}}>Perempuan
                                </label>
                            </div>
                            @error('jenis_kelamin')
                                <div class="text-danger">
                        ...
                        <div class="mt-4 mb-4">
                            ...
                            <select type="text" name="mapel_id" id="mapel_id" class="form-control @error('mapel_id') is-invalid @enderror">
                                ...
                                @enderror
                                    <option value="{{$guru->mapel_id}}" selected>{{! empty($guru->mapel->mapel) ?  $guru->mapel->mapel : ''}}</option>
                                @foreach($mapel as $m)
